...
const multerStorage = multer.diskStorage({
    ...
    filename: (req, file, cb) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (jsonArray.imageName) {
            const oldFilePath = path.join(__dirname, "../../uploads/pocetna", jsonArray.imageName);
        ...
        jsonArray.image =
            `${constants_1.x.URL}/uploads/pocetna/image` + path.extname(file.originalname);
...
exports.uploadPocetna = uploadPocetna;
