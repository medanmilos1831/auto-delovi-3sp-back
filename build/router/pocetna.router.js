...
exports.pocetnaRouter = void 0;
const express_1 = require("express");
const program_router_1 = require("./program.router");
...
const pocetnaRouter = (0, express_1.Router)();
exports.pocetnaRouter = pocetnaRouter;
...
program_router_1.programRouter.post("/upload-pocetna", multer_1.uploadPocetna.single("file"), (req, res) => {
    res.send("ok");
});
pocetnaRouter.post("/pocetna", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const jsonData = fs.readFileSync(filePath, "utf8");
        let aboutData = JSON.parse(jsonData);
        aboutData.headline = (_a = req.body.headline) !== null && _a !== void 0 ? _a : null;
        aboutData.desc = (_b = req.body.desc) !== null && _b !== void 0 ? _b : null;
...
pocetnaRouter.get("/pocetna", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const jsonData = fs.readFileSync(filePath, "utf8");
        let aboutData = JSON.parse(jsonData);
        ...
        res.send(Object.assign(Object.assign({}, aboutData), { programi: programs }));
    }
    catch (error) {
        res.status(error.code).send(error.message);
    }
...
pocetnaRouter.post("/pocetna/excel", upload.single("file"), (req, res) => {
    try {
        ...
        const createObjectFromData = (data) => {
            const result = {};
            data.forEach((item) => {
                const key = item.ARTIKAL_ID > 50000 && item.ARTIKAL_ID < 60000
                    ? "traktorski-program"
                    : "auto-program";
                ...
                if (!result[key]) {
                    result[key] = {
                        naziv: key === "auto-program" ? "auto program" : "traktorski program",
                        caption: null,
                        desc: null,
                        slug: key,
                        kategorije: {
