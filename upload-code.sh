...
zip -r $LOCAL_ZIP_FILE . -x "uploads/*"
...
if [ -d "/root/auto-delovi-3sp-back/uploads" ]; then
    # Premesti uploads folder u root
    mv /root/auto-delovi-3sp-back/uploads /root/uploads
    echo "Uploads folder je premešten u root i preimenovan u uploads-backup"
else
    echo "Uploads folder ne postoji u trenutnom projektu"
fi
...
#     mv /root/uploads /root/auto-delovi-3sp-back/uploads
#     echo "Uploads folder je vraćen u projekat"
# else
#     echo "Uploads folder ne postoji u root-u"
# fi
